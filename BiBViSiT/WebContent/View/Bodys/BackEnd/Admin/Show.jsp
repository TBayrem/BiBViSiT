...
<jsp:useBean id="msg" class="Model.Message" scope="session"></jsp:useBean>
 ...
 <div class="bs-docs-section">
		...
		<p> Wir Sind : <code><%=vectorAdmin.size()%></code>Admins</p>
		
		
	
  
 <div class="bs-example col-sm-6">
 <input type="text" id="SearchAdmin" class="form-control"  onkeyup="SearchAdmin(<%= vectorAdmin.size() %>)" placeholder="Admin Suchen">
		...
		<table class="table">
		<thead><tr><th>#</th><th>username</th><th>email</th><th>admin</th><th>active</th><th>Delete</th><th>Update Admin</th><th>Update Activ</th></tr></thead>
	    <tbody>
		...
		<td><%=A.getUserid()%></td><td id="<%=i%>"><%= A.getUsername()%></td><td><%= A.getEmail()%></td><td><% if (A.getAdmin().equalsIgnoreCase("Y"))out.print("Is Admin") ;else out.print("is Not Admin") ;%></td><td><% if (A.getActive().equals("Y")) out.print("active") ;else out.print("desactivated") ;%></td>
