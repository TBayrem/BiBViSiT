    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <div class="about-carousel wow fadeInLeft animated" data-wow-animation-name="fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
...
Diese Lücke hat uns auf die Idee gebracht, eine Webseite BIBVISIT zu erstellen, auf der Sie die Bibliothekskapazität überprüfen, einen Platz reservieren und garantieren können, dass Sie die Bibliothek betreten können
 ...
 Entwickelte Webseiten, die dem Benutzer unabhängig von seinem Endgerät ein optimales Lese- und Browsing-Erlebnis bieten  
          ...
          <div class="col-lg-6 col-sm-6 about-hiring">
            <div class="icon-wrap ico-bg round-five wow zoomIn animated" data-wow-duration="1s" data-wow-delay=".3s" data-wow-animation-name="zoomIn" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: zoomIn;">
              <i class="fa fa-user">
              </i>
            </div>
            <div class="content">
          ...
          <div class="col-lg-6 col-sm-6 about-hiring">
            <div class="icon-wrap ico-bg round-five wow zoomIn animated" data-wow-duration="1s" data-wow-delay=".5s" data-wow-animation-name="zoomIn" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: zoomIn;">
              <i class="fa fa-user">
              </i>
            </div>
            <div class="content">
          ...
          <div class="col-lg-6 col-sm-6 about-hiring">
            <div class="icon-wrap ico-bg round-five wow zoomIn animated" data-wow-duration="1s" data-wow-delay=".7s" data-wow-animation-name="zoomIn" style="visibility: visible; animation-duration: 1s; animation-delay: 0.7s; animation-name: zoomIn;">
              <i class="fa fa-user">
              </i>
            </div>
            <div class="content">
        ...
        <div class="row">
         ...
         während unserer Studium :
          ...
          <div class="col-lg-7" id="skillz">
            ...
            <div class="skill_bar">
              <div class="skill_bar_progress skill_one" style="width: 59.9974%; overflow: hidden;">
                <p>
            ...
            <div class="skill_bar">
              <div class="skill_bar_progress skill_two" style="width: 89.9987%; overflow: hidden;">
                <p>
            ...
            <div class="skill_bar">
              <div class="skill_bar_progress skill_three" style="width: 70.0068%; overflow: hidden;">
                <p>
            ...
            <div class="skill_bar">
              <div class="skill_bar_progress skill_four" style="width: 55.0013%; overflow: hidden;">
                <p>
